...
11. Run non-paid queue smoke and worker restart/idempotency validation before any PostgreSQL traffic switch.
...
- PostgreSQL candidate queue smoke and worker restart/idempotency validation
